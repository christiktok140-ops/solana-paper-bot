...
async function loadUser(userId) {
    try {
        ...
        if (doc.holdings) {
            for (const [mint, holding] of Object.entries(doc.holdings)) {
                holdingsMap.set(mint, holding);
            }
        }
